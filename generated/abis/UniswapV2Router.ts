...
export class UniswapV2Router__addLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapV2Router__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router__removeLiquidityETHResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router__removeLiquidityETHWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router__removeLiquidityWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2Router {
    return new UniswapV2Router("UniswapV2Router", address);
  }
  ...
  addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router__addLiquidityResult {
    ...
    return new UniswapV2Router__addLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router__addLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV2Router__addLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
    ...
    return new UniswapV2Router__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router__removeLiquidityETHResult {
    let result = super.call(
      "removeLiquidityETH",
    ...
    return new UniswapV2Router__removeLiquidityETHResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router__removeLiquidityETHResult> {
    let result = super.tryCall(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router__removeLiquidityETHResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapV2Router__removeLiquidityETHWithPermitResult {
    let result = super.call(
      "removeLiquidityETHWithPermit",
    ...
    return new UniswapV2Router__removeLiquidityETHWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<UniswapV2Router__removeLiquidityETHWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityETHWithPermit",
      "removeLiquidityETHWithPermit(address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router__removeLiquidityETHWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapV2Router__removeLiquidityWithPermitResult {
    let result = super.call(
      "removeLiquidityWithPermit",
    ...
    return new UniswapV2Router__removeLiquidityWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<UniswapV2Router__removeLiquidityWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityWithPermit",
      "removeLiquidityWithPermit(address,address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router__removeLiquidityWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
