...
export class ChainlinkOracle__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOracle__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOracle__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOracle__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOracle extends ethereum.SmartContract {
  ...
  try_getRoundData(
    ...
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOracle__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
